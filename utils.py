...
# In the parameter section, the code of Densefuse is retained.
...
def get_image(path, height=520, width=520, mode='RGB'):
    global image
    if mode == 'L':
...
def get_train_images_auto(paths, height=520, width=520, mode='RGB'):
